...
# Now I'm testing what it looks like to push multiple commits.
...
fires[is.na(fires$CAL_YEAR)==TRUE,6] <- paste(rep("Unburned", times=length(fires[is.na(fires$CAL_YEAR)==TRUE,6])))
